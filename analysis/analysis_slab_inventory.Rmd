...
cant_slab_inv <- m_cant_slab_inv_data_source(cant_3d)
...
cant_slab_bias %>% 
  ggplot(aes(gamma_slab, cant_pos_bias, fill = basin_AIP)) +
  geom_col() +
...
cant_slab_bias %>% 
  ggplot(aes(gamma_slab, cant_bias, fill = basin_AIP)) +
  geom_col() +
  scale_fill_brewer(palette = "Dark2") +
  coord_flip()
