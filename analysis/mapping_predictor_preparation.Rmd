...
if (params_local$predictor_climatology == "WOA18") {
  predictors <- full_join(WOA18_predictors_nuts_O2,
                          WOA18_predictors)
...
predictors <- natural_join(predictors, WOA18_predictors_nuts_O2,
...
predictors_surface <- predictors_surface %>% 
  ...
  fill(c(phosphate, silicate, TAlk, TCO2)) %>% 
  ungroup()
...
predictors <- inner_join(predictors, basinmask_excl_Japan)
predictors_surface <- inner_join(predictors_surface, basinmask_excl_Japan)
