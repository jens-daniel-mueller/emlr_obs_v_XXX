...
CFC_dcant_zonal <- CFC_dcant_zonal %>%
  mutate(
    pCFC_12_mean_pos = if_else(pCFC_12_mean < 0, 0, pCFC_12_mean),
    dcant_mean_pos = if_else(dcant_mean < 0, 0, dcant_mean),
    dcant_per_CFC = dcant_mean_pos / pCFC_12_mean_pos,
  ...
  mutate(
    dcant_per_CFC_log = if_else(dcant_mean_pos == 0,
                            0,
                            dcant_per_CFC_log),
    dcant_per_CFC_log = if_else(pCFC_12_mean_pos == 0,
                            max(dcant_per_CFC_log, na.rm = TRUE),
                            dcant_per_CFC_log)
  )
