...
Global C~ant~ inventories were estimated in units of Pg C, based on all vs positive only Cant estimates. Please note that here we only added cant values in the upper `r params_global$inventory_depth`m and do not apply additional corrections for areas not covered.
