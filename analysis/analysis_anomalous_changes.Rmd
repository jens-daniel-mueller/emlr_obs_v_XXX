...
cant_mod_3d <- bind_rows(
  ...
  cant_3d_mod_truth %>%
    ...
    select(-data_source) %>%
    mutate(estimate = "nss_mod_truth"),
  cant_3d_mod_truth_cc %>%
    filter(data_source == "mod_truth_cc") %>%
    select(-data_source) %>%
    mutate(estimate = "ss_mod_truth"),
  cant_3d_ss %>%
    filter(data_source == "mod") %>%
    select(-data_source) %>%
...
cant_mod_3d_bias <- cant_mod_3d_bias %>% 
  mutate(emlr_VS_ss_tss = emlr - ss_tss,
         emlr_VS_nss_mod_truth = emlr - nss_mod_truth,
         nss_mod_truth_VS_ss_mod_truth = nss_mod_truth - ss_mod_truth,
         nss_mod_truth_VS_ss_tss = nss_mod_truth - ss_tss) %>% 
...
cant_mod_3d_bias %>%
  ggplot(aes(emlr_VS_nss_mod_truth, emlr_VS_ss_tss)) +
...
cant_mod_3d_bias %>% 
  ggplot(aes(emlr_VS_ss_tss, nss_mod_truth_VS_ss_mod_truth)) +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = 0) +
  geom_bin2d(binwidth = 1) +
  scale_fill_viridis_c(trans = "log10") +
...
cant_mod_3d_bias %>% 
  ggplot(aes(nss_mod_truth_VS_ss_mod_truth, nss_mod_truth_VS_ss_tss)) +
  geom_hline(yintercept = 0) +
  geom_vline(xintercept = 0) +
  geom_bin2d(binwidth = 1) +
  scale_fill_viridis_c(trans = "log10") +
