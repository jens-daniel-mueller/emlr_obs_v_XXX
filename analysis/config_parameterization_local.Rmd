...
params_local <-
  lst(
    ...
    cruise_adjustment_relative = 0.1, # levels as absolute factor -1
    cruise_adjustment_absolute = 10, # levels in absolute µM
