...
params_local <-
  lst(
    ...
    # end years for eras
    era_end = c(1999,2019),
    # duplicated years from era 1 reused in era 2, thresholds years are not included
    dup_era1 = c(2009, 2009),
    # duplicated years from era 2 reused in era 1, thresholds years are not included
    dup_era2 = c(2010, 2010),
    # ID for basins for MLR fits (options: "2", "AIP", "5", "SO")
    MLR_basins = "5",
    # rarefication approach, options "none", "coarse_grid"
    rarefication = "none",
    # rarefication approach threshold
    rarefication_threshold = Inf,
    # Select the target variable for MLR, either "tco2", "cstar" or "cstar_tref"
    MLR_target = "cstar_tref",
    # see above
    MLR_predictors = MLR_predictors,
