...
GLODAP <- GLODAP %>% 
  mutate(cstar_tref_corr = if_else(
...
# GLODAP %>%
#   mutate(cstar_delta = cstar_tref - cstar_tref_corr) %>%
#   filter(cstar_delta != 0) %>%
#   distinct(basin_AIP, era, data_source)
