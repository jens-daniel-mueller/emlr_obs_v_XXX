...
Testes, but not applied.

```{r filter_reoccupied_observations, fig.asp=2, eval=FALSE}
...
map+
  geom_raster(data = GLODAP_grid,
              aes(lon, lat)) +
  facet_grid(gamma_slab ~ era_label)
  # scale_fill_manual(values = c("grey30", "grey70", "red"))
