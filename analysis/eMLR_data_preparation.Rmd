...
p_crossover_ts <- xover_IO_1990 %>%
  ...
  labs(title = "Crossover w. 316N199XXXXX IO") +
  theme(
...
p_crossover_2000 <- xover_IO_1990 %>%
  filter(year(dateB) >= 2000, year(dateB) < 2010) %>%
  ggplot(aes(y = offset)) +
  geom_hline(yintercept = 0) +
  geom_boxplot() +
  labs(title = "Mean 2000s") +
  facet_grid(parameter ~ ., scales = "free_y")

p_crossover_2010 <- xover_IO_1990 %>%
  filter(year(dateB) >= 2010, year(dateB) < 2020) %>%
  ggplot(aes(y = offset)) +
  geom_hline(yintercept = 0) +
  geom_boxplot() +
  labs(title = "Mean 2010s") +
  facet_grid(parameter ~ ., scales = "free_y")

p_crossover_ts + p_crossover_2000 + p_crossover_2010 +
  plot_layout(widths = c(3, 1, 1))

rm(p_crossover_ts, p_crossover_2000, p_crossover_2010)
