...
map +
  geom_raster(data = G19_cant_3d %>% distinct(lat, lon),
              aes(lon, lat, fill = "Gruber 2019 coverage")) +
  geom_raster(data = GLODAP %>% distinct(lat, lon),
              aes(lon, lat, fill = "GLODAP coverage")) +
...
map +
  geom_raster(data = S04_cant_3d %>% distinct(lat, lon),
              aes(lon, lat, fill = "Sabine 2004 coverage")) +
  geom_raster(data = GLODAP %>% distinct(lat, lon),
              aes(lon, lat, fill = "GLODAP coverage")) +
  scale_fill_viridis_d(name = "Source")
