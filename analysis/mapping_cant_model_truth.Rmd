...
cant_average <- left_join(basinmask, cant_average)

cant_average <- m_cant_model_average(cant_average %>% mutate(eras = "blank",
                                             gamma = 0))
...
cant_average %>%
  write_csv(paste(path_version_data,
                  "cant_3d_model_truth.csv", sep = ""))

cant_average_zonal %>%
  write_csv(paste(path_version_data,
                  "cant_zonal_model_truth.csv", sep = ""))

cant_inv %>%
  write_csv(paste(path_version_data,
                  "cant_inv_model_truth.csv", sep = ""))
