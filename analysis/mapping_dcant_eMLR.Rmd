...
dcant_surface <- dcant_surface %>%
  mutate(dcant = (1 / rev_fac) * (TCO2 / pCO2) * d_pCO2_tref)
...
dcant_average <- m_dcant_3d_MLR_average(dcant)
...
dcant_surface_average <-
  m_dcant_3d_MLR_average(dcant_surface)
...
dcant_predictor_zonal <-
  m_zonal_mean_sd(dcant_predictor_3d)
