...
- JGOFS_WOCE:
`r params_local$year_JGOFS_start` - `r params_local$year_JGOFS_end`

- GO_SHIP:
`r params_local$year_JGOFS_end+1` - `r params_local$year_GOSHIP_end`

- new_era:    > `r params_local$year_GOSHIP_end+1`


```{r assign_eras, eval=FALSE}
...
```{r switch_eras_manually, eval=FALSE}
...
GLODAP_histogram_year %>%
  ...
  geom_vline(xintercept = c(
    params_local$year_JGOFS_end + 0.5,
    params_local$year_GOSHIP_end + 0.5
  )) +
