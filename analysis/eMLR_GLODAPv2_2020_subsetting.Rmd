...
```{r phosphate_na_subset, fig.asp=0.7}
...
```{r phosphate_f_subset, fig.asp=0.7}
...
```{r phosphate_qc_subset, fig.asp=0.7}
...
```{r CANYON_B_removed_cruises_map, fig.asp=1.1}
