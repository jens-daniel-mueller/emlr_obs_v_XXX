...
GLODAP <- GLODAP %>%
  mutate(
    fill_nitrate = if_else(
      is.na(nitrate) & oxygenqc == 1 & cruise %in% c(342, 343),
      "filled",
      "measured"
    ),
    fill_phosphate = if_else(
      is.na(phosphate) & oxygenqc == 1 & cruise %in% c(342, 343),
      "filled",
      "measured"
    ),
    fill_silicate = if_else(
      is.na(silicate) & oxygenqc == 1 & cruise %in% c(342, 343),
      "filled",
      "measured"
    ),
    fill_talk = if_else(
      is.na(talk) & oxygenqc == 1 & cruise %in% c(342, 343),
      "filled",
      "measured"
    )
  )
